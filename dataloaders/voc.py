...
class VOC(BaseDataLoader):
    def __init__(self, data_dir, batch_size, split, crop_size=None, base_size=None, scale=True, num_workers=1, val=False,
                    shuffle=False, flip=False, rotate=False, blur= False, noise=False,augment=False, val_split= None, return_id=False):
        
        self.MEAN = torch.tensor([0.45734706, 0.43338275, 0.40058118])
        self.STD =  torch.tensor([0.23965294, 0.23532275, 0.2398498])
